...
%%  Graduate School SPECIFICATIONS (March 2014) for
%%	Preparation of Master's Thesis and Doctoral Dissertations
%% Version 1.12 written by John P. Weiss, 1997
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% uses a custom *.sty file that redefines bibliography command
	...
	\renewenvironment*{thebibliography}[1]{
		...
		\begin{singlespace}
		%bd trying to get the double line from toc \addcontentsline{toc}{part}{\bibnameToC}
	}{
		\end{singlespace}
...
\newcommand*{\th@PreChCmd}{
	...
	\else
		...
		%\setcounter{th@SaveFigure}{\value{includegraphics}}
...
\newcommand*{\th@PostChCmd}{
	...
	\else
		...
		%\setcounter{includegraphics}{\value{th@SaveFigure}}
